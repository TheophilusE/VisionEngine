...
static const DeviceId InvalidDeviceId = static_cast<unsigned int>(-1);
/// An invalid device button ID.
static const DeviceButtonId InvalidDeviceButtonId = static_cast<unsigned int>(-1);
/// An invalid user button ID.
static const UserButtonId InvalidUserButtonId = static_cast<unsigned int>(-1);
