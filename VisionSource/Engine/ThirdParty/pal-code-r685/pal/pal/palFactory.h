...
public:
    ...
    /**
		 ...
		 * \see #mat_rotate
		 */
    palLink* CreateLink(palLinkType type, palBodyBase* parent, palBodyBase* child, const palMatrix4x4& parentFrame, const palMatrix4x4& childFrame, bool disableCollisionsBetweenLinkedBodies = true);
    ...
    /**
		 ...
		 * \see #mat_rotate
		 */
    palLink* CreateLink(palLinkType type, palBodyBase* parent, palBodyBase* child, const palVector3& pivot, const palVector3& axis, bool disableCollisionsBetweenLinkedBodies = true);
    ...
    palRevoluteSpringLink* CreateRevoluteSpringLink(palBodyBase* parent, palBodyBase* child, const palVector3& pivot, const palVector3& axis, bool disableCollisionsBetweenLinkedBodies = true);
    ...
    /**
		 ...
		 */
    palRigidLink* CreateRigidLink(palBodyBase* parent, palBodyBase* child, bool disableCollisionsBetweenLinkedBodies = true);
    //
